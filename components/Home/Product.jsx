            ...
            <div className='container'>
                <div className="bg-[url('/images/probg.png')]  bg-cover bg-left md:bg-center pt-[45px]  mt-20 ">
                    ...
                    <div className='pt-[70px] ml-[180px] pb-[355px] probuttonn'>
                        <button className='text-[18px] text-[#FFFFFf] bg-[#008BBF] p-[18px] rounded-[10px] probutton italic' style={{ "box-shadow" : " 4px 4px 4px rgba(15, 124, 192, 0.25)"}}>SEE MORE DETAIL</button>
                    </div>
                </div>
            </div>
        </div>
