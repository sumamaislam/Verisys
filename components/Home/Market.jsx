      ...
      <div className='containers'>
        ...
        <div>
          ...
          <div className='flex gap-[73px] mt-[70px] flex-wrap m-auto justify-center gap_sizing'>
            ...
            <div className='borderColor py-[35px] px-[40px]  w-[300px]'>
              <div>
                <img className='flex justify-center m-auto' src="/images/industry.png" alt="" />
              </div>
            ...
            <div className='borderColor py-[35px] px-[40px]  w-[300px]'>
              <div>
                <img className='flex justify-center m-auto' src="/images/brandtech.png" alt="" />
              </div>
            ...
            <div className='borderColor py-[35px] px-[40px]  w-[300px]'>
              <div>
                <img className='flex justify-center m-auto' src="/images/agro.png" alt="" />
              </div>
            ...
            <div className='borderColor py-[35px] px-[40px]  w-[300px] '>
              <div>
                <img className='flex justify-center m-auto' src="/images/healthcare.png" alt="" />
              </div>
            ...
            <div className='borderColor py-[35px] px-[40px] w-[300px] '>
              <div>
                <img className='flex justify-center m-auto' src="/images/spirit.png" alt="" />
              </div>
